    ...
    <div className='nav'>
      <div className='nav--Bar'>
        ...
        <div className='Toolbar' style={{ display: visible ? 'none' : 'block' }}>
          <svg onClick={displayToolBar} className='btn--Close--Mobile' style={{ display: 'none' }} width="14" height="15" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='dark--Theme--Mobile' style={{ display: visible ? 'none' : 'block' }} onClick={displayToolBar}></div>
        <div>
          <section className='numberOfProducts'>
            <svg ref={shopRef} onClick={displayOptions} width="22" height="20" xmlns="http://www.w3.org/2000/svg">
          ...
          <img ref={avatarRef} src={Avatar} onClick={displayOptions} />
          {avatar ?
            <div className='shopping--Cart' ref={cartRef}>
              ...
              <div className='nav--Cart'>
                {amount > 0 ?
                  <span>
                    <div>
                      <img src={Photomini1} alt="Product Thumbnail" />
                      <section>
                      ...
                      <svg onClick={() => { dispatch(clearCart()) }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
